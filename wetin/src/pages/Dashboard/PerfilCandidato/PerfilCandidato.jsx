...
import convertToHexColor from "../../../utils/colorConverter";
...
export default function PerfilCandidato() {
  ...
  useEffect(() => {
    const fetchPerfilCandidato = async () => {
      try {
        ...
        setPerfilCandidato(response.data);
  ...
  const renderHabilidades = () => PerfilCandidato?.secao.map((secao, index) => (
     <React.Fragment key={index}>
        <div className={styles["box_secao"]}>
          <h3>{secao.titulo}</h3>
          <div className={styles["display_habilidades"]}>
          {secao.habilidade.map((texto, index) => (
            <div key={index} className={styles["box_habilidade"]} style={{backgroundColor: convertToHexColor(secao.cor)}}>
              {texto}
            </div>
          ))}
          </div>
              ...
              <div className={styles["card"]}>
                ...
                <div className={styles["listaInformacoes"]}>
                  ...
                  <div className={styles["informacoes-icones"]}>
                    ...
                    <h4> {PerfilCandidato?.tag.valor} - Brasil </h4>
                  </div>
                  <div className={styles["informacoes-icones"]}>
