import ImagemSolucao from "../assets/imgs/imgSolucao.png";

export default function BannerSolucao() {
    return (
        <div class="container_solucao">
            <div class="solucao">
                <div class="texto_solucao">
                    <span class="titulo_solucao">
                        Nossa Plataforma
                    </span>
                    <span class="explicacao_solucao">
                ...
                <div class="imgs">
                    <img src={ImagemSolucao} alt="" class="imgSolucao"/>
                </div>
            </div>
        </div>
    );
